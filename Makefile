...
release: build-linux-amd64 build-linux-arm64
	...
	cp modes.example.json setup_service.sh README.md .env.example LICENSE dist/scribo-linux-amd64/scribo/
	cp modes.example.json setup_service.sh README.md .env.example LICENSE dist/scribo-linux-arm64/scribo/
