.PHONY: build build-linux-amd64 build-linux-arm64 build-windows-amd64 build-windows-arm64 release run test clean
...
release: build-linux-amd64 build-linux-arm64 build-windows-amd64 build-windows-arm64
	rm -rf dist && mkdir -p dist/scribo-linux-amd64/scribo dist/scribo-linux-arm64/scribo dist/scribo-windows-amd64/scribo dist/scribo-windows-arm64/scribo
...
clean:
	rm -f scribo scribo-linux-amd64 scribo-linux-arm64 scribo-windows-amd64.exe scribo-windows-arm64.exe
	rm -rf dist
